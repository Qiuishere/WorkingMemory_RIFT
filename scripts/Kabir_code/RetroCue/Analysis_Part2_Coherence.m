...
%  RIFT Analysis | RetroCue | part 2 of 5
%
%  This file
...
% Parameters
f_s = 2048; % Hz
dt = 1/f_s; t_f = 3.4+2; % sec, window of RetroCue data is [-2, 2.5] with cue onset at 0
...
load('C:\Users\Arora003\Documents\[002] Data\InternalAttention_RetroCue_Project_64\Analysis\saved\t.mat');
...
xlim([-3.4, 1.9]); ylim([freq_labels(1), freq_labels(end)]); xline([-1.7, 0, 0.15], 'w--'); yline([60, 64], 'k-', 'LineWidth', 2)
