...
load('C:\Users\Arora003\Documents\[002] Data\InternalAttention_PreCue_Project_64\Analysis\saved\t.mat'); % timeline
attend_sides_mat = []; flicker_sides_mat = [];

for p = 1:length(participants)
    % Import good trialnumbers
    load(char("D:\Data\PreCue\"+participants(p)+"\preprocessing\clean\"+participants(p)+"_badtrial_idxs"));
    ...
    exp_info = readtable(char("D:\Data\ToUpload\Dissociating_External_and_Internal - Eyetracking Data\PreCue\"+participants(p)+"\trial_info.csv"));
...
load("C:\Users\Arora003\Documents\[002] Data\InternalAttention_PreCue_Project\Analysis\ReAnalyzed\freq_range_modified_new.mat"); 
timespan = -3.4:0.01:2; 
...
load("C:\Users\Arora003\Documents\[002] Data\InternalAttention_PreCue_Project\Analysis\ReAnalyzed\sig_neg_chans_alpha.mat");
load("C:\Users\Arora003\Documents\[002] Data\InternalAttention_PreCue_Project\Analysis\ReAnalyzed\sig_pos_chans_alpha.mat");
